...
namespace CSFramework {
	...
	public class Symbol : MonoBehaviour {
		...
		[Header("Generator Setting"), Range(0, 100), Tooltip("The parameter is used by SymbolGen and represents how often the symbol is randomly chosen to appears on a reel. The value is seen as relative weight in all the other symbols.  ")] public float[] frequencies;
