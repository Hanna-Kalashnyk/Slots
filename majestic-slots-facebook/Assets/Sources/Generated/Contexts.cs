...
public partial class Contexts : Entitas.IContexts {
    ...
    public UIListenersContext uIListeners { get; set; }

    public Entitas.IContext[] allContexts { get { return new Entitas.IContext [] { core, events, uIListeners }; } }
...
public partial class Contexts {
    ...
    public void InitializeContexObservers() {
        try {
            ...
            CreateContextObserver(uIListeners);
