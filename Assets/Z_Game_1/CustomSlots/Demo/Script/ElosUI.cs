...
namespace Elona.Slot {
	public class ElosUI : BaseSlotGameUI {
		...
		[SerializeField]
		public Button _buyTableButton;

        [SerializeField]
        public Button buyButton;

        [SerializeField]
        public Button _payTableButton;
        public static int currentSpingNumber;
		...
		public override void OnRoundComplete() {
            ...
            currentSpingNumber++;
                   ...
                   //print (currentSpingNumber + " is current spring");
            if (currentSpingNumber % 100 == 0){
				buyTable.SetActive (true);
                //print (currentSpingNumber + " NOW FROSTMOURNE!");
		...
		public void ToggleBuyTable() {
			assets.audioClick.Play();
			buyTable.SetActive(!buyTable.activeSelf);
		}
