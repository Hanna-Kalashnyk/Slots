...
namespace CSFramework {
	...
	public class BaseSlotGameUI : MonoBehaviour {
       ...
       //>>>>>>>>>>>>>>>>>>>>>>>>>>>>
        //Searching and triggering three Sunrise simbols in row togather
        /*[HideInInspector]*/
       // public Reel[] reels;
      //  [HideInInspector] public Row[] rows;
		...
		public virtual void RefreshBet() { textBet.text = "" + slot.gameInfo.bet; PlayerPrefs.SetInt("CURRENT_BET", slot.gameInfo.bet); }
